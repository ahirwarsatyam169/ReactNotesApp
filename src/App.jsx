        ...
        <div className="shadow-xl border border-sm  w-[90%] h-[90%] justify-center bg-gradient-to-r from-amber-200 to-yellow-200 relative">
          ...
          <div className="text-black/75 shadow-sm m-2 border-none rounded h-[60px] md:w-[99%] w-[95%] items-center flex p-2 text-xl bg-gradient-to-l from-amber-100 to-yellow-100 justify-between">
            ...
            {isMenuOpen && (
              <div className="overflow-auto absolute mt-4 top-[70px] right-0 h-[300px] w-[250px] bg-gradient-to-r from-amber-200 to-yellow-300 z-10 rounded-xl p-2 shadow-xl">
                <ul>
                  <button onClick={()=>newNote()} className="hover:shadow-[0px_0px_40px_rgba(255,255,255,0.5)] transition-all duration-300 hover:scale-[115%] active:scale-95 border rounded-[50px] items-center flex justify-center border-white/50 p-2 m-2 bg-gradient-to-r from-amber-100 to-yellow-300">New Note</button>
                  {AllNotes.map((titleList) => (
                    ...
                    >
                      ...
                      <button
                        className="transition-all duration-300 rounded-xl  active:scale-95 hover:shadow-[0px_0px_40px_rgba(255,255,255,0.5)] transition-all duration-300 hover:scale-[110%]" onClick={() => removeNote(titleList.id)}>
                        x
                      </button>
                    </li>
                  ))}
          ...
          <div className="w-[90%] flex justify-between p-2">
            <input
              ...
              type="text"
              className="text-lg text-black/75 border-none  hover:shadow-xl hover:shadow-[0px_0px_40px_rgba(255,255,255,0.5)] transition-all duration-300 focus:outline-none ml-[10px] mt-5  flex justify-center items-center h-[50px] md:w-[300px] w-[200px] rounded-xl p-2 bg-gradient-to-r from-amber-50 to-yellow-100 hover:scale-105"
              placeholder="title"
            />

            <div className="flex items-center md:mr-3 mr-[-20px] md:mt-2 mt-4">
              <button
                className="text-black/70 md:mr-8  h-[40px] md:w-[80px]  w-[90px] border-none bg-gradient-to-r from-amber-200 to-yellow-400 rounded-xl hover:shadow-xl hover:shadow-[0px_0px_40px_rgba(255,255,255,0.5)] transition-all duration-300 hover:scale-105 active:scale-95"
                onClick={saveNote}
              >
                save
              </button>
          ...
          <div className="flex justify-center ">
            <div className="h-[550px] w-[99%] flex items-center justify-center">
              <textarea
                ...
                className="border-none focus:outline-none resize-none  mt-2  w-[90%] h-[90%] rounded-xl p-4 bg-gradient-to-r from-amber-50 to-yellow-100 hover:scale-[102%] hover:shadow-xl hover:shadow-[0px_0px_40px_rgba(255,255,255,0.5)] transition-all duration-300 text-black/75 "
              />
            </div>
          </div>
        </div>
